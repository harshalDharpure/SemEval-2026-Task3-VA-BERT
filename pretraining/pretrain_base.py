...
# -*- coding: utf-8 -*-
"""
Pretraining Script for XLM-RoBERTa-BASE Model
...
def train_epoch(model, dataloader, criterion, optimizer, device, scaler=None, use_bfloat16=False):
...
def main():
    parser = argparse.ArgumentParser(description='Pretrain XLM-RoBERTa-BASE Model')
    ...
    print(f"Bfloat16: {CFG.use_bfloat16}")
    ...
    with open(results_log, 'w', encoding='utf-8') as log_file:
        ...
        for epoch in range(CFG.epochs):
            ...
            train_loss = train_epoch(model, train_loader, criterion, optimizer, CFG.device, scaler, CFG.use_bfloat16)
